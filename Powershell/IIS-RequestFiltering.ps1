<#
    Ref: https://docs.microsoft.com/en-us/iis/manage/configuring-security/configure-request-filtering-in-iis

    Def: Used to modify IIS Request filtering, more settings can be added or changed, consider add error handling and special output to improve even more the IIS security
#>
